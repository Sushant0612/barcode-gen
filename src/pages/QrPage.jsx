        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex flex-1 flex-col gap-4 bg-slate-50 p-6">
            ...
            >
              ...
              <div
                ref={labelCardRef}
                className="relative flex min-h-[180px] flex-col overflow-hidden rounded-[14px] border border-slate-200 bg-white px-4 py-2 shadow-sm"
              >

                <p className="mb-2 mt-1 text-[10px] font-bold uppercase tracking-[0.18em] text-slate-400">
                  {brandName || "—"}
                </p>
